...
VENV_NAME=connectomics-sandbox
...
pip install git+git://github.com/npinto/bangmetric.git
...
(cd ${CWD}/../external/sthor && git checkout develop && git pull develop && python setup.py develop)
